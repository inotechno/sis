...
<body>
    ...
    <table width="100%">
        <tbody>
            ...
            <tr>
                <td width="20%">Debit / Kredit</td>
                <td width="3%">:</td>
                <td width=""><?= ucfirst($debit_kredit) ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="3%">:</td>
                <td width=""><?= date('d-m-Y H:i:s', strtotime($created_at)) ?></td>
            </tr>
            <br>
            <tr>
            ...
            <h5>Berkas cetak ini merupakan bukti resmi status keuangan pesantren santri, simpan bukti ini jika suatu saat terjadi kesalahan pencatatan maka bukti ini harus di tunjukan.</h5>
