...
<div class="modal fade" id="modal-add-kehadiran" tabindex="-1" role="dialog" aria-labelledby="modal-add" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <form id="form-add-kehadiran" method="POST">
               <div class="row">
         ...
         <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" form="form-add-kehadiran">Save</button>
         </div>
      </div>
   </div>
</div>

<div class="modal fade" id="modal-update-kehadiran" tabindex="-1" role="dialog" aria-labelledby="modal-update" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <form id="form-update-kehadiran" method="POST">
               <div class="row">
         ...
         <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-warning" form="form-update-kehadiran">Save</button>
         </div>
      </div>
   </div>
</div>

<div class="modal fade" id="modal-delete-kehadiran" tabindex="-1" role="dialog" aria-labelledby="modal-delete" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <form id="form-delete-kehadiran" method="POST">
               <input type="hidden" name="id">
            </form>
         ...
         <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-danger" form="form-delete-kehadiran">Hapus</button>
         </div>
      </div>
   </div>
</div>