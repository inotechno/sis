<form id="form-checkout" method="POST" action="<?= site_url('_WaliSantri/SPP/pay') ?>">
   <!-- Page Content  -->
               ...
               <div class="iq-card">
                  <div class="iq-card-body">
                     <div class="form-group">
                        ...
                        <input type="text" id="nominal" name="nominal" readonly class="form-control" value="<?= $get['nominal'] ?>">
                     </div>
                  </div>
               </div>
            ...
            <div class="col-md">
               ...
               <div class="iq-card">
                  ...
                  <div class="iq-card-body">
                     ...
                     <input id="santri_id" name="santri_id" type="hidden" value="<?= $get['santri_id'] ?>" />
                     <input id="bulan" name="bulan" type="hidden" value="<?= $get['bulan'] ?>" />
