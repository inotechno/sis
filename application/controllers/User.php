...
class User extends MY_Controller
{
    ...
    {
        $this->session->set_userdata(['menu_active' => 'daftar-user', 'sub_menu_active' => '']);
        $menu = $this->MenusModel->getMenu();

        $data = [
            'content' => 'components/user',
            'plugin' => 'plugins/user',
            'css' => 'css/user',
    ...
    public function show()
    {
        ...
        $list = $this->UserModel->getUsers($where);
    ...
    public function all()
    {
        $data = $this->UserModel->all()->result();
