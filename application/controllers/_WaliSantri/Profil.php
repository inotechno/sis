...
class Profil extends MY_Controller
{
    ...
    {
        $this->session->set_userdata(['menu_active' => 'profil-ws', 'sub_menu_active' => '']);
        $menu = $this->MenusModel->getMenu();

        $data = [
            'content' => 'components/walisantri/profil',
            'plugin' => 'plugins/walisantri/profil',
            'css' => 'css/profil',
    ...
    {
        $data = $this->UserModel->GetProfil('wali_santri', ['u.id' => $this->session->userdata('id')])->row();
    ...
    public function UpdateProfil()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $user = $this->WaliSantriModel->update($id, $data);
