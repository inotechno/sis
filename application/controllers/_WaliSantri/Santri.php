...
class Santri extends MY_Controller
{
    ...
    {
        $this->session->set_userdata(['menu_active' => 'santri-ws', 'sub_menu_active' => '']);
        $menu = $this->MenusModel->getMenu();

        $data = [
            'content' => 'components/walisantri/santri',
            'plugin' => 'plugins/walisantri/santri',
            'css' => 'css/santri',
    ...
    public function show()
    {
        ...
        $list = $this->SantriModel->getSantri($where);
